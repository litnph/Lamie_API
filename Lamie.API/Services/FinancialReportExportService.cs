...
public sealed class FinancialReportExportService : IFinancialReportExportService
{
    ...
    public ReportFileDto CreatePrintableHtml(FinancialReportDto report)
    {
        ...
        html.Append(".totals{display:grid;grid-template-columns:repeat(3,1fr);gap:12px;margin:18px 0}");
        ...
        html.Append("</section>");
        html.Append("<h2>Diễn biến theo kỳ</h2><table><thead><tr><th>Kỳ</th><th class=\"number\">Doanh thu</th><th class=\"number\">Chi phí</th><th class=\"number\">Lợi nhuận</th><th class=\"number\">Số đơn</th><th class=\"number\">Số khoản chi</th></tr></thead><tbody>");
