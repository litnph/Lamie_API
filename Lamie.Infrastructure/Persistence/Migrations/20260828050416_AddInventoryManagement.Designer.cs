...
namespace Lamie.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260828050416_AddInventoryManagement")]
            ...
            modelBuilder.Entity("Lamie.Domain.Entities.InventoryStockUnit", b =>
                {
                    ...
                    b.HasIndex("IngredientId", "SizeKey")
                        .IsUnique()
                        .HasDatabaseName("ix_inv_stock_units_ingredient_id_size_key");
            ...
            modelBuilder.Entity("Lamie.Domain.Entities.InventoryStockUnit", b =>
                {
                    b.HasOne("Lamie.Domain.Entities.Ingredient", null)
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_inv_stock_units_md_ingredients_ingredient_id");
                });
